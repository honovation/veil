...
def vsee_config(config):
    ...
    for purpose in REDIS_CLIENTS:
        vsee_config['{}_redis_client'.format(purpose)] = {
    ...
    for purpose in PERSON_WEBSITE_BUCKETS:
        vsee_config['{}_bucket'.format(purpose)] = {
            'type': 'filesystem',
    ...
    for purpose in POSTGRESQL_CLIENTS:
        vsee_config['{}_database_client'.format(purpose)] = {
    ...
    for purpose in WEBSITES:
        vsee_config['{}_website'.format(purpose)] = {
