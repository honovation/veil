...
with veil_component.init_component(__name__):
    ...
    from veil.backend.database.new_database_client_setting import database_client_resource
    from veil.backend.new_redis_setting import redis_program
    from veil.backend.new_redis_setting import redis_client_resource
