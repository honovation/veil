...
with veil_component.init_component(__name__):
    ...
    from .redis_server_installer import redis_server_source_code_resource
    from .redis_server_installer import redis_server_os_source_code_resource

    __all__ = [
        register_redis.__name__,
        redis_client_resource.__name__,
        redis_server_resource.__name__,
        redis_server_source_code_resource.__name__,
        redis_server_os_source_code_resource.__name__,
    ]
