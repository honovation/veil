...
with veil_component.init_component(__name__):
    ...
    from .alipay_payment_ import refund
    from .alipay_payment_ import process_refund_notification
    from .alipay_payment_ import process_dback_notification
    from .alipay_payment_ import EVENT_ALIPAY_REFUND_NOTIFIED
    from .alipay_payment_ import ALIPayRefundException
