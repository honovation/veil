...
from .alipay_payment import verify_rsa, NOTIFICATION_RECEIVED_SUCCESSFULLY_MARK, EVENT_ALIPAY_TRADE_PAID
...
def create_alipay_wap_payment_url_(out_trade_no, subject, body, total_fee, show_url, return_url, notify_url, minutes_to_expire):
...
def query_status(out_trade_no):
    query_alipay_payment_status_(out_trade_no)


def query_alipay_payment_status_(out_trade_no):
    ...
    try:
        ...
        if arguments.is_success == 'T':
            ...
            discarded_reasons = process_alipay_payment_notification_(out_trade_no, arguments.trade, NOTIFIED_FROM_PAYMENT_QUERY)
...
def process_alipay_payment_notification_(out_trade_no, arguments, notified_from):
