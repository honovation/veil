...
from .sync_to_backup_mirror import sync_to_backup_mirror, SSH_KEY_PATH
...
def rsync_to_backup_mirror():
    ...
    sync_to_backup_mirror(backup_mirror, '{}/'.format(VEIL_BACKUP_ROOT), '{}/{}'.format(VEIL_ENV.name, server_guard.host_name))
