...
PYPI_INDEX_URL = 'http://mirrors.aliyun.com/pypi/simple/'  # the official url "https://pypi.python.org/simple/" is blocked
...
def veil_server(host_name, sequence_no, programs, resources=(), supervisor_http_port=None, name_servers=None, backup_mirror=None,
        mount_editorial_dir=False, mount_buckets_dir=False, mount_data_dir=False, memory_limit=None, cpu_share=None, ssh_port=None):
    from veil.model.collection import objectify
    if backup_mirror:
