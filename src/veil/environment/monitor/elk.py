...
def elk_resource(config):
    ...
    return [
        ...
        file_resource(path='/etc/sysctl.d/70-es-max-map-count.conf', content=render_config('max_map_count.conf'),
                      cmd_run_after_updated='sysctl -p /etc/sysctl.d/70-es-max-map-count.conf'),
