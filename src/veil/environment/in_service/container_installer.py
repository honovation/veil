...
def veil_container_init_resource(server):
    ...
    fabric.api.sudo('chroot {} apt-get -q -y install unattended-upgrades iptables git language-pack-en unzip wget python python-dev python-pip python-virtualenv'.format(container_rootfs_path))
