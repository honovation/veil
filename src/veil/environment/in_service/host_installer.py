...
def veil_host_init_resource(host):
    ...
    fabric.api.sudo('apt-get -q -y install ntpdate unattended-upgrades iptables git language-pack-en unzip wget python python-dev python-pip python-virtualenv lxc')
